...
async function migrateAll() {
  ...
  try {
    ...
    for (const tenant of tenants) {
      ...
      try {
        await tenantPool.query(`ALTER TABLE payments ADD COLUMN IF NOT EXISTS cancelled boolean DEFAULT false NOT NULL`);
        await tenantPool.query(`ALTER TABLE payments ADD COLUMN IF NOT EXISTS cancelled_at timestamp`);
